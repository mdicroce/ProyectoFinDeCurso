...
///EL PROBLEMA A RESOLVER es determinar si siguen vivos, porque deber�a decir que X esta muerto y hacer que su numero se vuelva -1 y no lo hace
/// PREGUNTAR como realizar los turnos (?)
/** Primero tenemos que volver a pensar en como se debe realizar esto. Primero se hac�a con una lista y un arreglo din�mico. La lista
guardaba los turnos y trabajaba como una cola, mientras que el arreglo guardaba una referencia al turno y esas cosas.

Tambi�n tengo que modificar las estructuras para poder designarle a cada uno de los bichos un identificador.*/
